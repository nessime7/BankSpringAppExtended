...
insert into cards (id,accountId,name,surname,maxLimit,maxDebet,cardType) values ('ac3a7a5a-1949-4182-b2ca-7f138bd19915','fc35ad28-91fc-449b-af3e-918417266f9d','Sara','Przebinda',100.0,100.0,'CREDIT');
insert into cards (id,accountId,name,surname,maxLimit,maxDebet,cardType) values ('71781a31-ed7f-4127-9734-aa4c23cb74a7','fc35ad28-91fc-449b-af3e-918417266f9d','Sara','Przebinda',100.0,100.0,'PAYMENT');
insert into cards (id,accountId,name,surname,maxLimit,maxDebet,cardType) values ('5e6e4432-1723-4e77-80d5-70cf1f83c80a','5f73cec7-6ac1-46ee-a203-794c35d8800c','Albert','Podraza',100.0,100.0,'PAYMENT');
insert into cards (id,accountId,name,surname,maxLimit,maxDebet,cardType) values ('bd8bcbc5-0a0b-47d0-8af9-2afc824a3a96','5f73cec7-6ac1-46ee-a203-794c35d8800c','Albert','Podraza',100.0,100.0,'CREDIT');
